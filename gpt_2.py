...
#     # Do not use return_tensors='jax'; convert manually
...
#     next_token = jnp.argmax(last_logits, axis=-1)  # Shape: (batch_size,)
#     predicted_token = tokenizer.decode(int(next_token.item()))  # Correct extraction
